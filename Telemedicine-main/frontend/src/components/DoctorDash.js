    ...
    <Box sx={{ height: "150vh", position: "absolute" }}>
      <Box
        sx={{
          ...
          width: "45vw",
          borderRadius: "15px",
          background: "linear-gradient(135deg, #2B7A78 10%, #3AAFA9 100%)",
          marginTop: "14vh",
          marginLeft: "8vw",
        }}>
        <Typography
          ...
          sx={{ color: "#FEFFFF", marginLeft: "3vw", paddingTop: "2vh" }}>
          {greeting}! {doc_name}
        </Typography>
        <Typography
          variant="h4"
            ...
            <Box
              ...
              <Box
                ...
                <Typography
                  ...
                  {item.nextAppointedDate.slice(8, 10)}
                  {item.nextAppointedDate.slice(4, 7)}-
                  {item.nextAppointedDate.slice(0, 4)}
                </Typography>
                ...
                <Box
                  ...
                  <Button
                    onClick={() => prescriptionHandler(idx)}
                    className="btn"
                    sx={{
